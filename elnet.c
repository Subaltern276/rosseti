/* ƒл€ использовани€ сети C:\NeuroShell 2\elnet вставьте этот код в вашу программу на €зыке C. */
/* Ётот код приспособлен дл€ простого и быстрого переноса на любой компьютер. */
/* ѕоэтому вс€ логика работы описана без использовани€ циклов и динамических массивов, */
/* что могло бы затруднить перенос кодов на разные компил€торы. */
 
#include <math.h>
 
void Fire_elnet(double *inarray, double *outarray)
{
 double netsum;
 double feature2[11];
...
/* outarray[1] - это выход - маркер устройства є1*/
/* outarray[2] - это выход - маркер устройства є2*/
/* outarray[3] - это выход - маркер устройства є3 */
/* outarray[4] - это выход - маркер устройства є4 */
/* outarray[5] - это выход - маркер устройства є5 */
